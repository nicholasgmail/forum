...
<head>
    ...
    <link href="{{ asset('css/app_post.css') }}" rel="stylesheet">
...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0" style="color:rgb(165, 0, 0)">
                Forum theme
            </div>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{'theme/' . $them->id}}"
                                    class="underline text-gray-900 dark:text-white">{{$them->name}}</a></div>
                        </div>
                    </div>
                    @endforeach
                </div>
